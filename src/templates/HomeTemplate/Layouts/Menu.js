...
export default function Menu() {
  return (
    <header style={{backgroundColor:'#000',opacity:0.5,zIndex:10}} className="p-4 dark:bg-coolGray-800 dark:text-coolGray-100 fixed top-0 left-0 w-screen">
      <div className="container flex justify-between h-16 mx-auto text-white">
        <a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 32 32" className="w-8 h-8 dark:text-violet-400">
        ...
        <ul className="it
        ems-stretch hidden space-x-3 lg:flex ">
          <li className="flex">
            <NavLink rel="noopener noreferrer" to="/home" className="flex items-center px-4 -mb-1 hover:border-b-2 active:border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400 text-white" >Home</NavLink>
          </li>
          <li className="flex">
            <NavLink rel="noopener noreferrer" to="/news" className="flex items-center px-4 -mb-1 hover:border-b-2 active:border-b-2 dark:border-transparent text-white">News</NavLink>
          </li>
          <li className="flex">
            <NavLink rel="noopener noreferrer" to="/about" className="flex items-center px-4 -mb-1 hover:border-b-2 active:border-b-2 dark:border-transparent text-white">About</NavLink>
          </li>
        </ul>
