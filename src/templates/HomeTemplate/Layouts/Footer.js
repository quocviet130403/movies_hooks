...
export default function Footer() {
  return (
    <footer className="py-6 dark:bg-coolGray-800 dark:text-coolGray-50" style={{backgroundColor:'#1e1e1e'}}>
          ...
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="#fff" className="flex-shrink-0 w-5 h-5 rounded-full dark:text-coolGray-900">
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          ...
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            ...
            <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-coolGray-900">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="#fff" className="w-5 h-5">
